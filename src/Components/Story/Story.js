...
function Story() {
  return (
    <div id="story" className="story-section">
      <h2 className="story-heading-closer">Our Story</h2>
      <p className="story-text">
        Aeolus is currently completing the Genesis Evolution Plus program with
        the Genesis center for Entrepreneurship. Katie Stone, 22, won the
        Genesis Centre's Pitch and Pick competition with the Aeolus Portable
      ...
      <div className="story-surface-dark">
        <h2 className="story-heading">Beginnings</h2>
        <p className="story-text">
      ...
      <div className="story-surface-grey">
        <h2 className="story-heading">News</h2>
        <p className="story-text">
          Aeolus has developed a robust and portable ventilator for use in
          developing countries. Katie Stone, 22, won the Genesis Centre's Pitch
          and Pick competition with the Aeolus Portable Ventilation System, a
      ...
      <div className="story-surface-blue">
        <h2 className="story-heading">Founders</h2>
        <p className="story-text">
          Aeolus has developed a robust and portable ventilator for use in
          developing countries. Katie Stone, 22, won the Genesis Centre's Pitch
          and Pick competition with the Aeolus Portable Ventilation System, a
